...
const SKILLS_DATA = [
  ...
  },
  {
    ...
    skills: [
      ...
      // Devicon'da Zustand va Element Plus yo'q, shuning uchun mos freymvork iconlari ishlatildi
...
const PROJECTS_DATA = [
  ...
  },
  {
    ...
    desc: "Alifshop shop site clone — I developed it while studying at Najot Ta'lim. The main focus was achieving real e-commerce UX and functionality. Fully responsive and modern design.",
    emoji: "🛒",
